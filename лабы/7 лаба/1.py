...
Vanya_regular_empoyee = Employee(name='Петров Иван Евгеньевич')
print(Vanya_regular_empoyee.get_info())
...
Katya_techManager = TechManager(name='Гончарова Екатерина Александровна', specialization='раздвоение личности', department='Шизофреническое отделение')
...
Katya_techManager.add_employee(Vanya_regular_empoyee)
